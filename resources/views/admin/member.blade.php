                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <span class="badge text-secondary bg-secondary-subtle">{{ $item->profesi }}</span>
                                            </div>
                                            <div class="mt-2 text-center pt-4 hstack gap-2 justify-content-center">
                                                ...
                                                <div class="avatar-xs">
                                                    <a href="{{ $item->linkedin_url }}" target="_blank" class="avatar-title rounded-circle bg-danger-subtle text-danger"><i class="ri-linkedin-fill align-middle"></i></a>
                                                </div>
                                            </div>
                                        </div>
