                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-sm-auto ms-auto">
                        <div class="list-grid-nav hstack gap-1">
                            <button class="btn btn-info addMembers-modal" data-bs-toggle="modal" data-bs-target="#addmemberModal"><i class="ri-add-fill me-1 align-bottom"></i> Add Program Kerja</button>
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                                    ...
                                    <div class="list-element">
                                        <div class="d-flex flex-column flex-sm-row mb-5">
                                            <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                                                ...
                                                <p class="text-muted mb-2">{{ $item->isi }}</p>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header p-4 pb-0">
                <h5 class="modal-title" id="createMemberLabel">Add Program Kerja</h5>
                <button type="button" class="btn-close" id="createMemberBtn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <form method="POST" action="{{ route('programkerja.store') }}" enctype="multipart/form-data" id="memberlist-form" class="needs-validation" novalidate>
                @csrf
                <div class="row">
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success">Add Program Kerja</button>
                    </div>
                </div>
            </form>
...
<div class="modal fade" id="editmemberModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header p-4 pb-0">
                <h5 class="modal-title" id="editMemberLabel">Edit Program Kerja</h5>
                ...
                <form method="POST" action="" enctype="multipart/form-data" id="edit-form" class="needs-validation" novalidate>
                    ...
                    <div class="row">                     
                        <div class="col-md-6 mb-3" id="title-wrapper">
                            <label for="edit-title"  class="form-label">Kategori</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            const actionUrl = `/programkerja/${articleId}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            // Fetch article data
            fetch(`/programkerja/${articleId}/edit`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Set form action
                        editForm.setAttribute('action', `/programkerja/${articleId}`);
                        
                        // Fill form fields
                        document.getElementById('edit-title').value = article.kategori;
                        document.getElementById('edit-description').value = article.isi;
