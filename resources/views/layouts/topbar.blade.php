                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://www.instagram.com/dokterseluruhindonesia/" target="_blank">
                                        <img src="{{ URL::asset('build/images/brands/instagram.png') }}" alt="instagram">
                                        <span>Instagram</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://www.tiktok.com/@pp_pdsi?_t=ZS-8xgE7ku1anX&_r=1" target="_blank">
                                        <img src="{{ URL::asset('build/images/brands/tiktok.png') }}" alt="tiktok">
                                        <span>Tiktok</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://www.facebook.com/officialpdsi" target="_blank">
                                        <img src="{{ URL::asset('build/images/brands/facebook.png') }}" alt="facebook">
                                        <span>Facebook</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">                                
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://id.linkedin.com/company/perkumpulan-dokter-seluruh-indonesia" target="_blank">
                                        <img src="{{ URL::asset('build/images/brands/linkedin.png') }}" alt="linkedin">
                                        <span>Linkedin</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="https://x.com/PP_PDSI" target="_blank">
                                        <img src="{{ URL::asset('build/images/brands/twitter.png') }}" alt="twitter">
                                        <span>X</span>
                                    </a>
                                </div>
                                <div class="col">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Str::limit(Auth::user()->anggota?->nama, 20) }}</span>
                                <span class="d-none d-xl-block ms-1 fs-13 text-reset user-name-sub-text">{{ Auth::user()->anggota?->profesi }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <h6 class="dropdown-header">Welcome {{ Str::limit(Auth::user()->anggota?->nama, 20) }}</h6>
