                    ...
                    <div class="col-sm-6">
                        <div>
                            ...
                            <div>
                                ...
                                <h5 class="text-muted mb-0">"Gantari", sans-serif</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <blockquote class="blockquote custom-blockquote blockquote-dark text-body rounded mb-0">
                                ...
                                <footer class="blockquote-footer mt-0 text-body">Angie Burt <cite title="Source Title">Designer</cite></footer>
                            </blockquote>
                        </div>
                    </div><!-- end row -->
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <blockquote class="blockquote custom-blockquote blockquote-outline blockquote-dark rounded mb-0 text-body">
