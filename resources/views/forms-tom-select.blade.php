...
@section('title') @lang('translation.tom-select') @endsection
@section('css')
<link href="{{ URL::asset('build/libs/tom-select/css/tom-select.bootstrap5.min.css') }}" rel="stylesheet">
@endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') Forms @endslot
@slot('title') Tom Select @endslot
@endcomponent
...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div>
                    <select class="data-flag">
                        <option value="Ascension Island" data-src="{{ URL::asset('build/images/flags/ac.svg') }}">Ascension Island</option>
                        <option value="Andorra" data-src="{{ URL::asset('build/images/flags/ad.svg') }}">Andorra</option>
                        <option value="United Arab Emirates" data-src="{{ URL::asset('build/images/flags/ae.svg') }}">United Arab Emirates</option>
                        <option value="Afghanistan" data-src="{{ URL::asset('build/images/flags/af.svg') }}">Afghanistan</option>
                        <option value="Antigua and Barbuda" data-src="{{ URL::asset('build/images/flags/ag.svg') }}">Antigua and Barbuda</option>
    ...
    &lt;option value=&quot;Ascension Island&quot; data-src=&quot;build/images/flags/ac.svg&quot;&gt;Ascension Island&lt;/option&gt;
    &lt;option value=&quot;Andorra&quot; data-src=&quot;build/images/flags/ad.svg&quot;&gt;Andorra&lt;/option&gt;
    &lt;option value=&quot;United Arab Emirates&quot; data-src=&quot;build/images/flags/ae.svg&quot;&gt;United Arab Emirates&lt;/option&gt;
    &lt;option value=&quot;Afghanistan&quot; data-src=&quot;build/images/flags/af.svg&quot;&gt;Afghanistan&lt;/option&gt;
&lt;/select&gt;</code></pre>
                    </div>
                </div>
                <div class="col-lg-6">
...
<script src="{{ URL::asset('build/libs/tom-select/js/tom-select.complete.min.js') }}"></script>
<script src="{{ URL::asset('build/libs/tom-select/js/plugins/remove_button.js') }}"></script>
<!-- input flag init -->
