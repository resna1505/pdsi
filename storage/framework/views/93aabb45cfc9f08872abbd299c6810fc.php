        ...
        <div class="card overflow-hidden profile-setting-img">
            ...
            <div class="card-body">
                <div class="position-relative mb-3">
                    <div class="mt-n5">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-lg rounded-circle p-1 mt-n4">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/pages-profile-settings.blade.php ENDPATH**/ ?>