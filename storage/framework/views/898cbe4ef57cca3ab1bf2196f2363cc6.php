<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.leaderboard'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?>  Apps  <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Leaderboard <?php $__env->endSlot(); ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex border-bottom pb-3">
                            ...
                            <div class="flex-shrink-0">
                                <div class="avatar-sm">
                                    <span class="avatar-title rounded fs-2">
                                        <img class="rounded img-fluid" src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="Header Avatar">
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                            </div>
                ...
                <div class="card">
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                            </div>
                ...
                <div class="card">
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                            </div>
                        ...
                        <tbody>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-9.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
...
<script src="<?php echo e(URL::asset('build/libs/tom-select/js/tom-select.base.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/libs/apexcharts/apexcharts.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/pages/leaderboard.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/apps-leaderboards.blade.php ENDPATH**/ ?>