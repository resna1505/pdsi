...
<link href="<?php echo e(URL::asset('build/libs/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
                            ...
                            <div class="col-xxl-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-2 mb-3">
                                        <div class="col-lg-2">
                                            <a href="#!">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="img-fluid rounded" />
                                            </a>
                                        </div>
                                        <div class="col-lg-2">
                                            <a href="#!">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="#!" class="border rounded-pill p-1 d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="avatar-xs rounded-circle object-cover" />
                                            <span class="inline-block fw-medium px-2">ICT PDSI PDSI</span>
                                        </a>
                                        <a href="#!" class="border rounded-pill p-1 d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" class="avatar-xs rounded-circle object-cover" />
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-header p-4">
                                        <div class="d-flex gap-3 align-items-center mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" alt="" height="25">
                                            </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="#!">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="img-fluid object-cover h-100">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper images-menu mb-3">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Bootstrap"><img src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Website"><img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Responsive"><img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Design"><img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="eCommerce"><img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Templates"><img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Admin Panal"><img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Simple"><img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Dark"><img src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Users"><img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div>
                                                <a href="javascript:void(0);" class="stretched-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Office"><img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" class="avatar-sm rounded-circle object-cover" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row" id="gallery-element">
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer bg-light">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                                        <h5 class="overlay-caption card-caption-title text-truncate mb-0">Working at a coffee shop</h5>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card border-0 gallery-card cursor-pointer">
                                                <div>
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" class="card-img-top gallery-img" />
                                                </div>
                                                <div class="card-body">
                                                    <a href="#!">
                                                        <h5 class="overlay-caption card-caption-title text-truncate mb-0">Working at a coffee shop</h5>
                            ...
                            <div class="col-xxl-4" id="overview-cardelem">
                                <div class="main-img card p-2" id="gallerycard-overview">
                                    <div class="position-relative">
                                        ...
                                        <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" id="current" class="img-fluid rounded" />
                                ...
                                <div class="row mt-3 g-3">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="position-relative border-0">
                                            <div>
                                                <img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" class="img-fluid rounded" />
                                            </div>
                                            <div class="mt-2">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="position-relative border-0">
                                            <div>
                                                <img src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" class="img-fluid rounded" />
                                            </div>
                                            <div class="mt-2">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="position-relative border-0">
                                            <div>
                                                <img src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" class="img-fluid rounded" />
                                            </div>
                                            <div class="mt-2">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="position-relative border-0">
                                            <div>
                                                <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="img-fluid rounded" />
                                            </div>
                                            <div class="mt-2">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="col-xxl-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" width="125" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                <ul class="list-inline mb-2">
                                                    <li class="list-inline-item"><i class="ph-broadcast-bold me-1"></i> News TV</li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/pages-search-results.blade.php ENDPATH**/ ?>