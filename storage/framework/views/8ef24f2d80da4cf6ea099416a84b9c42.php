                    ...
                    <div class="card-body p-4 p-sm-5 m-lg-2">
                        ...
                        <div class="p-2">
                            <form method="POST" wire:submit="resetPassword">
                                <input type="hidden" value="<?php echo e($email); ?>" wire:model.live="email">
                                <input type="hidden" value="<?php echo e($token); ?>" wire:model.live="token">
                                <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php /**PATH D:\Project\pdsi\resources\views/livewire/auth/new-password.blade.php ENDPATH**/ ?>