                            ...
                            <div class="col-lg-7">
                                <div class="card mb-0 border-0 py-3 shadow-none">
                                    <div class="card-body px-0 p-sm-5 m-lg-4">
                                        <div class="d-flex justify-content-center">
                                            <img src="<?php echo e(URL::asset('build/images/logo-sm-bottom.png')); ?>" alt="" height="100" />
                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                                   wire:model.live="tempat_lahir" value="<?php echo e(old('tempat_lahir')); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                                                                   wire:model.live="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                                                                   wire:model.live="no_hp" value="<?php echo e(old('no_hp', '08')); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                                                                      ...
                                                                      autocomplete="alamat" autofocus placeholder="Masukan alamat domisili" rows="3"><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" type="radio" name="profesi" id="sarjana" value="Sarjana Kedokteran" wire:model.live="profesi">
...
unset($__errorArgs, $__bag); ?>" type="radio" name="profesi" id="umum" value="Dokter Umum" wire:model.live="profesi">
...
unset($__errorArgs, $__bag); ?>" type="radio" name="profesi" id="spesialis" value="Dokter Spesialis" wire:model.live="profesi">
...
unset($__errorArgs, $__bag); ?>" type="radio" name="profesi" id="otherRadio" value="other" wire:model.live="profesi">
                                                                <label class="form-check-label" for="otherRadio">
                                                                    Other
                                                                </label>
                                                            </div>
                                                    
                                                            <!--[if BLOCK]><![endif]--><?php if($profesi === 'other'): ?>
                                                                <input type="text" class="form-control mt-2" placeholder="Masukkan profesi lainnya" wire:model.live="otherProfesi">
                                                            <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
                                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['profesi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" wire:model.live="ktp"
                                                                   value="<?php echo e(old('ktp')); ?>" required autocomplete="off"
                                                                   placeholder="Enter your ktp">
                                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['ktp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" wire:model.live="npwp"
                                                                   value="<?php echo e(old('npwp')); ?>" required autocomplete="off"
                                                                   placeholder="Enter your npwp">
                                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['npwp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" wire:model.live="avatar"
                                                                   value="<?php echo e(old('avatar')); ?>" required autocomplete="off"
...
unset($__errorArgs, $__bag); ?>"" wire:model.live="otp" required autocomplete="off" placeholder="Enter your OTP">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-check <?php $__errorArgs = ['remember'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['remember'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex mt-2">
                                            ...
                                            <div class="flex-grow-1 ms-2 ">
                                                <p class="text-muted mb-0">Tidak ada data transaksi iuran di rekening PDSI Pusat  yang sesuai dengan informasi yang diberikan PDSI Cabang atau entri data iuran.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex mt-2">
                                            <div class="flex-shrink-0">
