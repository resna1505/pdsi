                                ...
                                <div class="card auth-card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden">
                                    <div class="card-body p-4 d-flex justify-content-between flex-column">
                                        <div class="auth-image">
                                            ...
                                            </div>                                              <img src="<?php echo e(URL::asset('build/images/effect-pattern/auth-effect-2.png')); ?>" alt="" class="auth-effect-2" />
                                        ...
                                        <div class="text-center text-white-75">
                                            <p class="mb-0">&copy; <script>
                                                ...
                                                </script> PDSI. Crafted with <i class="mdi mdi-heart text-danger"></i> by ICT PDSI </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\Project\pdsi\resources\views/livewire/auth/forget-password.blade.php ENDPATH**/ ?>