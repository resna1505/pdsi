                                ...
                                <div class="card auth-card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden mb-0">
                                    <div class="card-body p-4 d-flex justify-content-between flex-column">
                                        <div class="auth-image mb-3">
                                            <img src="<?php echo e(URL::asset('build/images/logo-light-full.png')); ?>" alt="" height="26" />
                                ...
                                <div class="card mb-0 border-0 shadow-none">
                                    <div class="card-body px-0 p-sm-5 m-lg-4">
                                        <div class="error-img text-center px-5">
                                            <img src="<?php echo e(URL::asset('build/images/error400.png')); ?>" class="img-fluid" alt="">
                                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/auth-404-basic.blade.php ENDPATH**/ ?>