        ...
        <div class="card overflow-hidden">
            ...
            <div class="card-body">
                <div class="position-relative">
                    <div class="mt-n5">
                        <img src="<?php echo e(URL::asset('storage/images/users/' . Auth::user()->avatar)); ?>" alt="" class="avatar-lg rounded-circle p-1 mt-n4">
                    </div>
                </div>
                <div class="pt-3">
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active"> 
                                            <div class="d-bloack img-fluid mx-auto" style="background: url('<?php echo e(URL::asset('build/images/kta_pdsi_depan.png')); ?>') no-repeat center center; background-size: cover; width: 300px; height: 500px; position: relative;">
                                                <div style="position: absolute; 
                                                    ...
                                                    <img src="<?php echo e(URL::asset('storage/images/users/' . Auth::user()->avatar)); ?>" 
                                                        alt="First slide" 
                                                        style="width: 100%; 
                                                                height: 100%; 
                                                                object-fit: cover;
                                                ...
                                                <div style="position: absolute; bottom: 60px; left: 0; right: 0; text-align: center; color: white; font-weight: bold;">
                                                    No.Urut Anggota : <?php echo e(Auth::user()->id); ?>

                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item"> 
                                            <div class="d-bloack img-fluid mx-auto" style="background: url('<?php echo e(URL::asset('build/images/kta_pdsi_belakang.png')); ?>') no-repeat center center; background-size: cover; width: 300px; height: 500px; position: relative;">
                                                <div style="position: absolute; 
                                                            top: 15%; 
                                                            left: 83%; 
                                                            transform: translate(-50%, -50%); 
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item">
                                                            <div class="avatar-xs">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="rounded-circle img-fluid" />
                                                            </div>
                                                        </div>
                                                        <div class="avatar-group-item">
                                                            <div class="avatar-xs">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-2.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-3.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-5.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        <div class="avatar-group-item">
                                                            <div class="avatar-xs">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle img-fluid" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-4.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-8.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item">
                                                            <div class="avatar-xs">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt="" class="rounded-circle img-fluid" />
                                                            </div>
                                                        </div>
                                                        <div class="avatar-group-item">
                                                            <div class="avatar-xs">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="<?php echo e(URL::asset('build/images/companies/img-7.png')); ?>" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                                        </div>
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/pages-profile.blade.php ENDPATH**/ ?>