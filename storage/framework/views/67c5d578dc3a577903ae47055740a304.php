        ...
        <div class="card">
            <div class="card-body p-4 m-2">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e(URL::asset('build/images/users/avatar-9.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                </div>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body p-4 m-2">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" alt="" class="avatar-md rounded-3" />
                </div>
                <div class="text-center">
                    <a href="#member-overview" data-bs-toggle="offcanvas">
                                ...
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="avatar-lg">
                                        <div class="avatar-title bg-light rounded-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/user-dummy-img.jpg')); ?>" id="member-img" class="avatar-md rounded-3 h-auto" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="member-overview">
    ...
    <div class="offcanvas-body profile-offcanvas p-0">
        ...
        <div class="p-3 text-center">
            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-lg img-thumbnail rounded-4 mx-auto profile-img">
            <div class="mt-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/pages-team.blade.php ENDPATH**/ ?>