...
<div class="offcanvas offcanvas-end" tabindex="-1" id="viewContactoffcanvas" aria-labelledby="viewContactoffcanvasLabel">
    ...
    <div class="offcanvas-body">
        <div class="text-center">
            <div class="mb-3">
                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-lg d-block mx-auto rounded-circle overview-userimg" />
            </div>
                        ...
                        <div class="position-relative d-inline-block">
                            ...
                            <div class="avatar-lg">
                                <div class="avatar-title bg-light rounded-circle">
                                    <img src="<?php echo e(URL::asset('build/images/users/user-dummy-img.jpg')); ?>" id="contact-img" class="avatar-md rounded-circle" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/contact.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/apps-contact.blade.php ENDPATH**/ ?>