                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 avatar-xs">
                                        <span class="avatar-title bg-light p-1 rounded-circle">
                                            <img src="<?php echo e(URL::asset('build/images/old_logo-sm.png')); ?>" class="img-fluid"
                                                alt="">
                                        </span>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="<?php echo e(URL::asset('build/images/products/img-10.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="<?php echo e(URL::asset('build/images/products/img-9.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                                                </div>
...
<script src="<?php echo e(URL::asset('build/js/pages/timeline.init.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('build/js/pages/chart-dokter.init.js')); ?>"></script>
