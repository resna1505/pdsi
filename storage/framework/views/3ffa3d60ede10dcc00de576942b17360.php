...
<div class="row gy-4">
    ...
    <div class="col-xxl-4 col-lg-6 align-self-center">
        <div class="text-center">
            <div class="mb-4">
                <img src="<?php echo e(URL::asset('build/images/faq.png')); ?>" alt="" height="200">
            </div>
            <h4>Any Questions ?</h4>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\pdsi\resources\views/pages-faqs.blade.php ENDPATH**/ ?>